...
- Create a copy of ``djangoDocker/settings/local.py.example`` in ``djangoDocker/settings/local.py``
- Create a ``.env`` file in the root of the project and add ``DJANGO_SETTINGS_MODULE="djangoDocker.settings.local"`` to it
